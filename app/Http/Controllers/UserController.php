...
class UserController extends Controller
{
    ...
    public function userManagement()
    {
        $user_datas = User::leftJoin('users as user', 'user.id', '=', 'users.created_user_id')
            ...
            ->paginate(10);
        return view('user/user-management', compact('user_datas'));
    }
    /**
     ...
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */
    public function confirmUserInformation(Request $request)
    {
        ...
        return view('user/user-confirm', compact('user_datas'));
    }
